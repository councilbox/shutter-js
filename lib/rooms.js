...
const UPDATE_STATUS = `
	mutation updateRoomStatus($roomNumber: String!, $status: String!) {
		updateRoomStatus(roomNumber: $roomNumber, status: $status) {
			userID
			organizationID
			type
			displayName
...
module.exports = class Rooms {
	...
	async updateStatus({ roomNumber, status }) {
		const variables = { roomNumber, status };
